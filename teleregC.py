...
class Register:
    ...
    def lägg_till(self, personer):
        ...
        efternamn = felhanteringC2.namn(("Ange efternamn: "))
        förnamn = felhanteringC2.namn(("Ange förnamn: "))
        telefonnummer = felhanteringC2.telefonnummer(("Ange telefonnummer: "))
        epost = felhanteringC2.email(("Ange epost: "))
        adress = felhanteringC2.adress(("Ange adress: "))
    ...
    def ta_bort(self, personer):
        namn = felhanteringC2.namn(("För vilket objekt önskas det att byta attributet 'epost'? Ange först förnamn och sedan efternamn: "))
    ...
    def ändra_telefonnummer(self, personer):
        namn = felhanteringC2.namn(("För vilket objekt önskas det att byta attributet 'telefonnummer'? Ange först förnamn och sedan efternamn: "))
        person = personer[namn]
        del personer[person.telefonnummer]
        person.telefonnummer = felhanteringC2.telefonnummer((f"Ange det nya telefonnumret för {namn}: "))
    ...
    def ändra_epost(self, personer):
        ...
        person.epost = felhanteringC2.email((f"Ange det nya epost för {namn}: "))
        personer[person.epost] = person
        print(f"Nu är epostadressen för {namn} bytt till {person.epost}")

    def ändra_adress(self, personer):
        namn = felhanteringC2.namn(("För vilket objekt önskas det att byta attributet 'adress'? Ange först förnamn och sedan efternamn: "))
        person = personer[namn]
        person.adress = felhanteringC2.adress(((f"Ange den nya adressen för {namn}: ")))
